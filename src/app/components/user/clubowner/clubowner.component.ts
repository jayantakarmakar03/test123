...
@Component({
  selector: 'app-clubowner',
  templateUrl: './clubowner.component.html',
  styleUrls: ['./clubowner.component.css']
})
export class ClubownerComponent implements OnInit {
...
doc_array=[
  ...
  goToClubMAnagement(clubownerID){

    this._router.navigate(['/club-module/club',clubownerID]);
